...
namespace Swordfish.NET.TestV3.UnitTests
{
  ...
  public class ConcurrentObservableSortedSetTests
  {
    ...
    {
      using (var benchmark = new BenchmarkIt("Generating Test Input Collections"))
      {
    ...
    {
      using (var benchmark = new BenchmarkIt("Generating Expected Output"))
      {
    ...
    public void AddTest()
    {
      ...
      using (var benchmark = new BenchmarkIt("Adding items to test subject"))
      {
        // Create test subject
