...
namespace DGGroupSortFilterExample
{
    ...
    public partial class MainWindow : Window
    {
        public MainWindow()
        {
            ...
            Projects _tasks = (Projects)this.Resources["tasks"];

            // Generate some task data and add it to the task list.
            for (int i = 1; i <= 14; i++)
            {
                _tasks.Add(new Project()
                {
    ...
    public class Project : INotifyPropertyChanged, IEditableObject
    {
        ...
        private Project temp_Task = null;
        ...
        public void BeginEdit()
        {
            if (m_Editing == false)
            {
                temp_Task = this.MemberwiseClone() as Project;
                m_Editing = true;
            }
        }
